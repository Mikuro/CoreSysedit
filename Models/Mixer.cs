...
namespace tanks.Models
{
    ...
    public class Mixer : ProcessUnit
    {
        ...
        [PortType(PortType.InPort | PortType.Port1 | PortType.Part0 | PortType.PfPartKindPressure)]
        public Stream f2 { get { return ports[1]; } set { ports[1] = value; } }
        [PortType(PortType.InPort | PortType.Port2 | PortType.Part0 | PortType.PfPartKindPressure)]
        public Stream f3 { get { return ports[2]; } set { ports[2] = value; } }
        [PortType(PortType.OutPort | PortType.Port3 | PortType.Part0 | PortType.PfPartKindPressure)]
        public Stream p1 { get { return ports[3]; } set { ports[3] = value; } }
        ...
        public override double[] pfGraphPFE(int j, ref double b, int n, FlowDiagram flowDiagram)
        {
            ...
            /*
            if (f1 != null) a[f1.fn] = 1;
            if (f2 != null) a[f2.fn] = 1;
            if (f3 != null) a[f3.fn] = 1;
            a[p1.fn] = -(cf[0] * cf[0] + cf[1] * cf[1] + cf[2] * cf[2]);
            b = 0;
            */
