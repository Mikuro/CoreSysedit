	...
	public static class XMLUtil
	{
        ...
        private static IReadOnlyList<XElement> Collection_ModelLink_to_node(Collection<tanks.Models.ModelLink> arr, XNamespace[] nss)
        {
            ...
            for(int i=0; i<arr.Count; i++)
            {
                ...
                {
                case "Signal":
                    link = Signal_to_node(arr[i] as Models.Signal,nss);
                    break;
                case "Stream":
                    link = Stream_to_node(arr[i] as Models.Stream,nss);
                    break;
                default:
                        throw new Exception("fail");
                }
		...
		private static XElement CalculationSystem_to_node(tanks.Models.CalculationSystem obj, XNamespace[] nss)
		{
		...
		private static XElement Component_to_node(tanks.Models.Component obj, XNamespace[] nss)
		{
		...
		private static XElement ControlValve_to_node(tanks.Models.ControlValve obj, XNamespace[] nss)
		{
		...
		private static XElement FlowDiagram_to_node(tanks.Models.FlowDiagram obj, XNamespace[] nss)
		{
		...
		private static XElement FlowMeter_to_node(tanks.Models.FlowMeter obj, XNamespace[] nss)
		{
		...
		private static XElement HeatExchanger_to_node(tanks.Models.HeatExchanger obj, XNamespace[] nss)
		{
		...
		private static XElement LiquidLevelMeter_to_node(tanks.Models.LiquidLevelMeter obj, XNamespace[] nss)
		{
		...
		private static XElement LiquidTank_to_node(tanks.Models.LiquidTank obj, XNamespace[] nss)
		{
		...
		private static XElement Mixer_to_node(tanks.Models.Mixer obj, XNamespace[] nss)
		{
		...
		private static XElement PIDController_to_node(tanks.Models.PIDController obj, XNamespace[] nss)
		{
		...
		private static XElement Pipe_to_node(tanks.Models.Pipe obj, XNamespace[] nss)
		{
		...
		private static XElement PressureFeed_to_node(tanks.Models.PressureFeed obj, XNamespace[] nss)
		{
		...
		private static XElement PressureGauge_to_node(tanks.Models.PressureGauge obj, XNamespace[] nss)
		{
		...
		private static XElement PressureProduct_to_node(tanks.Models.PressureProduct obj, XNamespace[] nss)
		{
		...
		private static XElement Pump_to_node(tanks.Models.Pump obj, XNamespace[] nss)
		{
		...
		private static XElement Signal_to_node(tanks.Models.Signal obj, XNamespace[] nss)
		{
		...
		private static XElement Splitter_to_node(tanks.Models.Splitter obj, XNamespace[] nss)
		{
		...
		private static XElement Strainer_to_node(tanks.Models.Strainer obj, XNamespace[] nss)
		{
		...
		private static XElement Stream_to_node(tanks.Models.Stream obj, XNamespace[] nss)
		{
		...
		private static XElement Thermometer_to_node(tanks.Models.Thermometer obj, XNamespace[] nss)
		{
...
// ---------------------------------
		...
		private static tanks.Models.CalculationSystem CreateFromCalculationSystem_node(XmlNode node)
		{
			return new tanks.Models.CalculationSystem{
                SRKKIJ = CreateFromCollection_double_array_node(XAttr(node,"SRKKIJ")),
			};
		}
		private static tanks.Models.Component CreateFromComponent_node(XmlNode node)
		{
		...
		private static tanks.Models.ControlValve CreateFromControlValve_node(XmlNode node)
		{
		...
		private static tanks.Models.FlowDiagram CreateFromFlowDiagram_node(XmlNode node)
		{
		...
		private static tanks.Models.FlowMeter CreateFromFlowMeter_node(XmlNode node)
		{
			return new tanks.Models.FlowMeter{
                ...
                unit = (EUMassOrVolume)Enum.Parse(typeof(EUMassOrVolume),
                NAttr(node,"unit",typeof(tanks.Models.EUMassOrVolume))),
                t_unit = (EUTime)Enum.Parse(typeof(EUTime),
		...
		private static tanks.Models.HeatExchanger CreateFromHeatExchanger_node(XmlNode node)
		{
		...
		private static tanks.Models.LiquidLevelMeter CreateFromLiquidLevelMeter_node(XmlNode node)
		{
			return new tanks.Models.LiquidLevelMeter{
                ...
                unit = (EULevel)Enum.Parse(typeof(EULevel),
		...
		private static tanks.Models.LiquidTank CreateFromLiquidTank_node(XmlNode node)
		{
		...
		private static tanks.Models.Mixer CreateFromMixer_node(XmlNode node)
		{
		...
		private static tanks.Models.PIDController CreateFromPIDController_node(XmlNode node)
		{
			return new tanks.Models.PIDController{
                ...
                INCDEC = (PIDDirection)Enum.Parse(typeof(PIDDirection),
                ...
                MV = Double.Parse(NAttr(node,"MV",typeof(System.Double)), CultureInfo.InvariantCulture),
                CMOD = (PIDMode)Enum.Parse(typeof(PIDMode),
		...
		private static tanks.Models.Pipe CreateFromPipe_node(XmlNode node)
		{
		...
		private static tanks.Models.PressureFeed CreateFromPressureFeed_node(XmlNode node)
		{
		...
		private static tanks.Models.PressureGauge CreateFromPressureGauge_node(XmlNode node)
		{
			return new tanks.Models.PressureGauge{
                ...
                unit = (EUPressure)Enum.Parse(typeof(EUPressure),
		...
		private static tanks.Models.PressureProduct CreateFromPressureProduct_node(XmlNode node)
		{
		...
		private static tanks.Models.Pump CreateFromPump_node(XmlNode node)
		{
		...
		private static tanks.Models.Signal CreateFromSignal_node(XmlNode node)
		{
		...
		private static tanks.Models.Splitter CreateFromSplitter_node(XmlNode node)
		{
		...
		private static tanks.Models.Strainer CreateFromStrainer_node(XmlNode node)
		{
		...
		private static tanks.Models.Stream CreateFromStream_node(XmlNode node)
		{
			return new tanks.Models.Stream{
                Type = (PipeType)Enum.Parse(typeof(PipeType),
		...
		private static tanks.Models.Thermometer CreateFromThermometer_node(XmlNode node)
		{
			return new tanks.Models.Thermometer{
                ...
                unit = (EUTemperature)Enum.Parse(typeof(EUTemperature),
